...
Function.help = function(json,callback){
    var content = "欢迎使用肇庆无线公交!\ue159\n" +
        "1.查看该线路公交车到了哪个站:请回复公交线路名称(例如15或15路或15线).\n" +
        "2.查看从当前位置到目的地的导航信息:请回复到XX(地名).\n" +
        "3.查看周围情况:请回复附近XX(例如附近公交站,附近美食).\n" +
        "4.查看导航信息:请回复从XX(地名)到XX(地名)(例如从市法院到北门).\n" +
        "5.查看经过该站的路线:请回复站名(例如北门).";
    var xml = response.responseText(json,content);
    callback(xml);
}
